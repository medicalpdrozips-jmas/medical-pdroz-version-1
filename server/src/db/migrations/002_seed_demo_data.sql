...
insert into crh.patients (
  ...
  primary_diagnosis, status, contract_id, program, risk_clinical, risk_financial, accumulated_cost_display, next_ai_action
) values
  (
    ...
    'Priorizar control reumatologico y adherencia al biologico.'
  ),
  (
    ...
    'Correlacionar respuesta terapeutica y consumo biologico.'
  )
on conflict (id) do nothing;
